...
<html lang="en">
<head>
    <title>Code coverage report for src/formatters/simple-detail.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/formatters/</a> simple-detail.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Template Author Sindre Sorhus @eslint
...
&nbsp;
  results.forEach(function (result) {
    ...
    var warnings = 0;
    var errors = 0;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!messages.length) {
...
&nbsp;
        return ['',
          ...
          chalk.gray(message.ruleId || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>];
      }), tableSettings);
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Feb 23 2016 11:10:45 GMT-0700 (MST)
</div>
</div>
